...
<!-- Mirrored from skyux.com/themes/nexus/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Sep 2015 23:17:33 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <title>Sitando</title>
    <meta name="description" content="Sitando.">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="index-5.html">Multi-Page</a></li>
                                    </ul>
                                </li>
                            </ul>
                                                    </li>
    ...
    <div class="container">
        <div class="title-wrapper">
            <div class="hero-title">
                <h2>Bienvenue à Sitando</h2>
                <h3>Sitando</h3>
            </div>
            <div class="meta">
                <p class="blurb">Commencez votre nouveau projet avec une nouvelle approche. Sitando est vraiment à la
                    pointe en termes de conception et de performances. Laissez à vos visiteurs une expérience
                    inoubliable. <a
                ...
                <a href="http://themeforest.net/item/nexus-responsive-multipurpose-html5-template/10789597"
                    target="blank" class="button round brand-1">à propos de nous</a>
        ...
        <div class="welcome-titles">
            <header class="welcome-content">
                <div class="section-title">
                    <h2><b>Sitando</b></h2>
                    <h3>
                        Nous sommes fière de réaliser les projets de nos clients partout dans le monde
...
<section class="section services primary section-map inactive" id="s-services">
    <div class="container">
        <header class="sep active">
            ...
            <p class="sub-text">Suspendisse tempus sodales neque, eget eleifend <a href="#">turpis tristique</a> eu.
                Nullam a nisl maximus, ultrices est ut blandit nislr, elit in lobortis mattis.</p>
        </header>
        <div class="owl-carousel services-slider">
            <div class="widget service">
                <div class="widget-content">
                    ...
                    <p>Cum socis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec
                        finibus fringilla purus. Integer libero justo, mattis et magna eget.</p>
                </div>
            </div>
            <div class="widget service">
                <div class="widget-content">
...
<div class="site-overlay invisible" id="site-overlay"></div>
    ...
    <div class="options-content">
        ...
        <div class="row bp0 page-type">
            <div class="span-6">
                <a href="index-single.html" class="button brand-1-active round full-width">
                	One Page
                </a>
            </div>
            <div class="span-6">
                <a href="index-2.html" class="button round brand-1-active full-width active">
                	Multi-Page
                </a>
            </div>
        </div>
...
<!-- Mirrored from skyux.com/themes/nexus/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Sep 2015 23:18:25 GMT -->
</html>
