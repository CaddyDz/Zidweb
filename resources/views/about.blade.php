...
<!-- Mirrored from skyux.com/themes/nexus/demo/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Sep 2015 23:19:01 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="further about">
    ...
    <div class="container inactive">
        <div class="sh-title-wrapper">
            ...
            <a href="http://themeforest.net/item/nexus-responsive-multipurpose-html5-template/10789597" target="blank" class="button border round cta">Purchase Theme</a>
        </div>
    </div>
</section>
        <!-- Breadcrumb -->
    ...
    <div class="container">
        <ul>
            <li class="home"><a href="index-2.html"><i class="fa fa-home"></i></a></li>
            <li><a href="index-2.html">Nexus</a></li>
    ...
    <div class="container">
        <div class="content">
            ...
            <p>leave your visitors with an experience to remember and <a href="http://themeforest.net/item/nexus-responsive-multipurpose-html5-template/10789597" target="blank">Purchase Nexus</a> now.</p>
        </div>
        <div class="meta">
            <a href="http://themeforest.net/item/nexus-responsive-multipurpose-html5-template/10789597" target="blank" class="button brand-1 round">Purchase Theme</a>
...
<!--[if !IE]><!--> <script src="assets/js/theme-options.js"></script> <!--<![endif]-->
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC9kOt-o-2NU7_pcjkGIj4f8cKPw_xinco&amp;sensor=false"></script>
